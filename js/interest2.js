...
function rollupInterest(data) {
  ...
  for (i=0; i<data.length; i++) {
    ...
    desiredArray.push(
      {
          maininterest:  data[i].maininterest,
...
// Read data
d3.json("./data/pixstoryinterest2.json", function(data) {
  ...
  // data = data.filter(function(d){ return d.count>300 && d.count<1000 }) 
  ...
  console.log(data)
  console.log(rollupInterest(data))
...
// console.log(arraydata)
  ...
  var color = d3.scaleOrdinal()
    .domain(["sports", "entertainment", "health", "politics", "education"])
    .range(d3.schemeSet1);
